...
startup
{
    ...
    settings.SetToolTip("Infos", "Check this option if you want to show Information.");
...
start
{
    ...
    if (!current.isMissionText && old.isMissionText && vars.characters[current.character] == "Ada" && current.room == 288 && settings["AssignmentAdaSplits"])
    {
