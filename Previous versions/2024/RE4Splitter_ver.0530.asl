...
state("bio4", "1.1.0")
{
    ...
    bool isCutscene       : 0x867C0D; // Realtime Rendering Cutscenes
    ...
    bool isEndOfChapter   : 0x867BA1; // End Of Chapter
...
update
{
    ...
    // Cutscenes
    bool isCutscenes = (current.isCutscene || current.isMovie || current.isEvent) && current.menu != 2 && !current.isEndOfChapter;
